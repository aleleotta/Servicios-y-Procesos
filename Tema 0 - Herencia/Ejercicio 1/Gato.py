...
declarar el constructor adecuado de forma que una vez creados objetos de cada una de las
clases anteriores y tras imprimirlos por pantalla el resultado sea:
(ver diagrama)
"""